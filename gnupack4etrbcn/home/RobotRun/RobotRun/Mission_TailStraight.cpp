...
public:
    ...
    Mission_TailStraight(S32 timer = 0, S16 speed = 125) 
		...
		, run_straight_midle_(new ControlMission_Posture(RobotCmd::NO_TAIL_CNTL,RobotCmd::NO_TAIL_CNTL,0,0), new ControlMission_SpeedPID(&pid_trace_, 20,40, 1, 100), RobotCmd::NORMAL_MODE)
