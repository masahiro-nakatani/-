/*
 *  kernel_cfg.c
 *  Thu Sep 24 17:59:52 2015
 *  SG Version 2.00
 *  sg.exe Main.oil -os=ECC2 -IC:\gnupack4etrbcn\home\nxtOSEK\toppers_osek/sg/impl_oil -template=C:\gnupack4etrbcn\home\nxtOSEK\toppers_osek/sg/lego_nxt.sgt
 */
...
const AlarmType Alarm4msec = 0;

DeclareTask(TaskDrive);
DeclareEvent(EventDrive);
static void _setevent_alarm_Alarm4msec( void );
static void _setevent_alarm_Alarm4msec( void )
{ (void)SetEvent( TaskDrive, EventDrive ); }

const CounterType alminib_cntid[TNUM_ALARM] = { 0, };
const FP alminib_cback[TNUM_ALARM] = { _setevent_alarm_Alarm4msec, };
const AppModeType alminib_autosta[TNUM_ALARM] = { 0x00000000, };
const TickType alminib_almval[TNUM_ALARM] = { 0, };
const TickType alminib_cycle[TNUM_ALARM] = { 0, };
...
const ResourceType Resource_DEList = 0;
...
const EventMaskType EventDrive = (1UL << 0);
const EventMaskType EventSleepI2C = (1UL << 1);
const EventMaskType EventSleep = (1UL << 2);
